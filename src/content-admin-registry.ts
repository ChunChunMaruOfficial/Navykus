...
export const ADMIN_CONTENT_TYPES = [
  ...
  },
  {
    ...
    fields: [
      ...legacyPublishedFields,
      { name: 'page', label: 'Страница', type: 'select', required: true, options: ['about', 'championship', 'activities'], defaultValue: 'about' },
      ...
      { name: 'value', label: 'Русский текст', type: 'textarea', required: true },
    ],
  },
  {
    key: 'pillars',
