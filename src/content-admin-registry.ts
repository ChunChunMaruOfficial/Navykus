...
export const ADMIN_CONTENT_TYPES = [
  {
    ...
    group: 'content',
    titleField: 'name',
    searchFields: ['name', 'country', 'city', 'shortBio'],
    listFields: ['name', 'country', 'moderationStatus', 'isApproved'],
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'pitch', label: 'Pitch', type: 'textarea' },
  ...
  },
  {
    ...
    listFields: ['title', 'category', 'status', 'isPublished'],
    supportsDraftStatus: true,
    usesPublishedFlag: true,
    publicPath: '/blog',
    fields: [
      ...
      { name: 'category', label: 'Category', type: 'select', required: true, options: ['news', 'championships', 'activities', 'opportunities', 'stories', 'interviews', 'tips', 'education', 'projects'], defaultValue: 'tips' },
      { name: 'tags', label: 'Tags', type: 'list' },
      { name: 'status', label: 'Status', type: 'select', required: true, options: ['draft', 'pending_review', 'needs_revision', 'approved', 'published', 'rejected', 'archived'], defaultValue: 'published' },
      { name: 'coverAlt', label: 'Cover alt', type: 'text' },
      { name: 'isApproved', label: 'Approved', type: 'checkbox', defaultValue: true },
      { name: 'publishedAt', label: 'Published at', type: 'date' },
      ...seoFields,
    ],
  ...
  },
  {
    ...
    group: 'settings',
    titleField: 'label',
    searchFields: ['label', 'email', 'phone', 'telegram'],
    listFields: ['label', 'email', 'telegram'],
    fields: [
