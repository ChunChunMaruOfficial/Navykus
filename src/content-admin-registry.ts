...
export const ADMIN_CONTENT_TYPES = [
  ...
  },
  {
    ...
    group: 'content',
    titleField: 'label',
    searchFields: ['label', 'translationKey', 'value', 'page', 'language'],
    listFields: ['page', 'language', 'label', 'isPublished'],
    requiresPublishedFlag: true,
    publicPath: '/about',
    fields: [
      ...legacyPublishedFields,
      { name: 'page', label: 'Page', type: 'select', required: true, options: ['about', 'championship'], defaultValue: 'about' },
      { name: 'language', label: 'Language', type: 'select', required: true, options: SUPPORTED_LANGUAGES, defaultValue: 'ru' },
