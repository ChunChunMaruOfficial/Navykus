...
import TeamMembersModerationView from './TeamMembersModerationView';

export type TeamMembersModerationServerProps = {
  clientConfig: any;
...
const TeamMembersModeration = (props: TeamMembersModerationServerProps) => {
  const {
    initPageResult,
    i18n,
    importMap,
  ...
  return (
    <DefaultTemplate
      ...
      viewType={viewType}
    >
      <TeamMembersModerationView />
    </DefaultTemplate>
  );
};

export default TeamMembersModeration;
