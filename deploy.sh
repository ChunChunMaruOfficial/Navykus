...
NAVYKUS_DOMAIN="${NAVYKUS_DOMAIN:-navykus.tech}"
NAVYKUS_ADMIN_EMAIL="${NAVYKUS_ADMIN_EMAIL:-admin@navykus.tech}"
...
if [[ -n "${NAVYKUS_DOMAIN}" && "${NAVYKUS_DOMAIN}" != "navykus.tech" ]]; then
